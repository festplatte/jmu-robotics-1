...
\begin{document}
	...
	\begin{itemize}
		...
		\item Path of knot points: for continuous motion infinite accelerations would be applied (instead stop at every knot point and do separate trajectory plannings) $\rightarrow$ cubic polynomial interpolation
	\end{itemize}
	% TODO continue at chapter 4, slide 41
